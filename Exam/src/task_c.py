...
def task_c():
    ...
    axs.plot(data[:4000,1,1,0], data[:4000,1,1,1], label=r"$S_1$")
    axs.plot(data[:4000,2,1,0], data[:4000,2,1,1], label=r"$S_2$")
    axs.plot(data[:4000,3,1,0], data[:4000,3,1,1], label=r"$S_3$")
    axs.set_xlabel(r"$S_x$")
    axs.set_ylabel(r"$S_y$")
    axs.legend()
    fig.tight_layout()
    #fig.savefig("../plots/task_cpolar.png", dpi=300)
    plt.show()
